...
namespace ScentifyAdmin.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Perfumed_Notes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Flacon = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Composition = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Gender = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    FragranceFamily = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
